...
$m_fruits = [
  ...
  [ "ID" => "3", "Nama" => "Jeruk", "color" => "Oren", "stock" => 50, "price" => 18000, "description" => "Jeruk dengan rasa yang manis dan dijamin enak"],
  [ "ID" => "4", "Nama" => "Rambutan", "color" => "Merah", "stock" => 70, "price" => 15000, "description" => "Buah rambutan dengan kualitas yang baik dan harga murah"],
